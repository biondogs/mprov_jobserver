...
class JobServerPlugin(threading.Thread):
    ...
    def set_job_running(self):
        ...
        return self.js.update_job_status(self.jobModule, JobStatus.RUNNING)

    def set_job_success(self):
        # This function can be overridden, especially if you are processing specific jobID's.
        return self.js.update_job_status(self.jobModule, JobStatus.SUCCESS)

    def set_job_failure(self):
        self.threadOk = False
        # This function can be overridden, especially if you are processing specific jobID's.
        return self.js.update_job_status(self.jobModule, JobStatus.FAILED)
    ...
    def handle_jobs(self):
        ...
        print(
            self.jobModule
            + ": Sleeping 15 seconds to simulate work.  Override 'handle_jobs()' to do something useful."
        )
        sleep(15)
